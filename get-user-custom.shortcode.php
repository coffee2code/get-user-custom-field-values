...
class c2c_GetUserCustomFieldValuesShortcode {
	 ...
	 * @access public
	 * @since 007
	 * @var c2c_GetUserCustomFieldValuesShortcode
	 */
	...
	public static function register() {
		self::$instance = new self( $GLOBALS['wp_widget_factory']->widgets['c2c_GetUserCustomWidget'] );
	}
	...
	public function can_author_use_shortcodes( $user = null, $post = null ) {
		 ...
		 * can use the 'user_custom_field' shortcode, or to have their use of it
		 * evaluated.
		 *
		 ...
		 */
		return (bool) apply_filters( 'get_user_custom_field_values/can_author_use_shortcodes', $can, $user, $post );
	}
	 ...
	 * Shortcode handler.
	 *
	 * @since 3.3 Prevent evaluation of shortcodes in posts author by users who cannot publish unfiltered HTML.
	 *
...
JS;
	...
	public function form() {
		...
		printf(
			...
			esc_attr( $this->name ),
			esc_attr__( 'Send shortcode to editor', 'get-user-custom-field-values' )
		);
	}
